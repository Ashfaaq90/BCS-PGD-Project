...
<!-- Content -->
  <div id="content">
    ...
    <form action="<?php echo $this->baseURL ?>cart/addservice" method="post" enctype="multipart/form-data">
        <input type="text" name="description" value="Booklets - A4" style="display: none;"/>
        <table width="666">
          <tr>
        ...
        <table width="610" id="t01" border="1px">
          ...
          <tr>
            ...
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-250-1000" checked="checked" >
              Rs. 1000</td>
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-500-1550">
              Rs. 1550</td>
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-100-2300">
              Rs. 2300</td>
          ...
          <tr>
            ...
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-250-3100">
              Rs. 3100</td>
            ...
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-1000-4500">
              Rs. 4500</td>
            <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-2500-5000">
              Rs. 5000</td>
