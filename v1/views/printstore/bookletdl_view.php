...
<!-- Content -->
  <div id="content">
    ...
    <form action="<?php echo $this->baseURL ?>cart/addservice" method="post" enctype="multipart/form-data">
        <input type="text" name="description" value="Booklets-DL(198x210 mm)" style="display: none;"/>
        <table width="666">
          <tr>
      ...
      <tr>
        ...
        <td width="95"  height="30" style="padding-left:5px"> <input type="radio" name="selection" value="8 Pages-250-1000">
          Rs. 1000</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-500-1550">
          Rs. 1550</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-1000-2300">
          Rs. 2300</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-1500-2800">
          Rs. 2800</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="8 Pages-2000-3200">
          Rs. 3200</td>
      </tr>
      <tr>
        <td width="95" height="30"  style="padding-left:5px">16 Pages</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-250-311">
          Rs. 3100</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-500-3900">
          Rs. 3900</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-1000-4500">
          Rs. 4500</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-1500-5000">
          Rs. 5000</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="16 Pages-2000-5400">
          Rs. 5400</td>
      </tr>
      <tr>
        <td width="95" height="30"  style="padding-left:5px">24 Pages</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="24 Pages-250-5300">
          Rs. 5300</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="24 Pages-500-6000">
          Rs. 6000</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="24 Pages-1000-6900">
          Rs. 6900</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="24 Pages-1500-7500">
          Rs. 7500</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="24 Pages-2000-8000">
          Rs. 8000</td>
      </tr>
      <tr>
        <td width="95" height="30"  style="padding-left:5px">32 Pages</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="32 Pages-250-8100">
          Rs. 8100</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="32 Pages-500-8700">
          Rs. 8700</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="32 Pages-1000-9800">
          Rs. 9800</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="32 Pages-1500-10300">
          Rs. 10300</td>
        <td width="95"  height="30" style="padding-left:5px"><input type="radio" name="selection" value="32 Pages-2000-10750">
          Rs. 10750</td>
      </tr>
    </table>
        <table width="666">
